...
/**
 * Provides the local service interface for ProjectContact. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ProjectContactLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface ProjectContactLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ProjectContactLocalServiceUtil} to access the project contact local service. Add custom service methods to <code>com.pathmazing.projectcontact.service.impl.ProjectContactLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	public ProjectContact addProjectContact(ProjectContact projectContact);
	...
	public ProjectContact createProjectContact(long projectContactId);
	...
	public ProjectContact deleteProjectContact(long projectContactId)
		throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public ProjectContact deleteProjectContact(ProjectContact projectContact);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ProjectContact fetchProjectContact(long projectContactId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ProjectContact getProjectContact(long projectContactId)
		throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public ProjectContact updateProjectContact(ProjectContact projectContact);
